...
const storageKey = ref(Date.now()) // Trigger để force re-check
...
// Listen to custom event for same-page localStorage changes
...
// Watch route changes to re-check user role
watch(() => route.path, () => {
  checkUserRole()
})
</script>
...
<template>
  ...
  >
    <div class="relative h-full">
      ...
      <div class="tab-item" :class="{ active: route.name === 'Flashcard' }">
        <router-link to="/flashcard" class="tab-item__link">
          <span class="tab-item__icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <span class="tab-item__link--text">Flashcard</span>
        </router-link>
      </div>
      ...
      <div v-if="isAdmin" class="tab-item" :class="{ active: route.path?.includes('/admin') }">
        <router-link to="/admin/dashboard" class="tab-item__link admin-link">
          <span class="tab-item__icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <span class="tab-item__link--text">Admin Panel</span>
        </router-link>
      </div>
